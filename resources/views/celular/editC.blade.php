...
<form action="/celulares/{{$celular->id}}" method="POST">
    ...
    <div class="mb-3"
        ...
        <input id="descripcion" name="descripcion" type="text" class="form-control" value="{{ $celular->descripcion }}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input id="precio" name="precio" type="number" step="any" value="0.00" class="form-control" value="{{ $celular->precio }}">
    </div>
